...
export function Modal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-foreground/40 backdrop-blur-sm p-0 sm:items-center sm:p-4">
      <div className="flex max-h-[85vh] w-full max-w-md flex-col rounded-t-3xl border border-border-subtle bg-white p-5 shadow-[0_24px_48px_-20px_rgba(43,45,90,0.32)] sm:rounded-3xl">
